...
echo.
echo          The Setup program prepares WIN-DOS 1.55 to run on your
echo          computer.
echo.           
...
echo  -----------------------
echo.
echo           WIN-DOS 1.55 is now installed on your computer.
echo.
echo              - To restart your computer with WIN-DOS 1.55,
echo                press ENTER.
pause >nul
goto start3
