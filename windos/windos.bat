...
echo.
echo          The Setup program prepares WIN-DOS 1.50 to run on your
echo          computer.
echo.           
...
echo  -----------------------
echo.
echo           WIN-DOS 1.50 is now installed on your computer.
echo.
echo              - To restart your computer with WIN-DOS 1.50,
echo                press ENTER.
pause >nul
goto start3
...
:command
echo.
echo Microsoft(R) WIN-DOS(R) Version 1.50
