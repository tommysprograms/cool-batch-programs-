...
echo.
echo          The Setup program prepares WIN-DOS 1.70 to run on your
echo          computer.
echo.           
...
echo  -----------------------
echo.
echo           WIN-DOS 1.70 is now installed on your computer.
echo.
echo              - To restart your computer with WIN-DOS 1.70,
echo                press ENTER.
pause >nul
goto start3
...
:command
echo.
echo Microsoft(R) WIN-DOS(R) Version 1.70
...
if /I "%usercmd%"=="graphics.com" goto graphics
if /I "%usercmd%"=="power" goto power
if /I "%usercmd%"=="power.exe" goto power
if /I "%usercmd%"=="sys" goto sys
if /I "%usercmd%"=="sys.com" goto sys
