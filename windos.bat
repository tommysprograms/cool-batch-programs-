...
echo.
echo          The Setup program prepares WIN-DOS 1.31 to run on your
echo          computer.
echo.           
...
echo  -----------------------
echo.
echo           WIN-DOS 1.31 is now installed on your computer.
echo.
echo              - To restart your computer with WIN-DOS 1.31,
echo                press ENTER.
pause >nul
goto start3
